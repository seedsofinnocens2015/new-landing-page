    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         हम सीड्स ऑफ़ इनोसेंस IVF में मुजफ्फरपुर में फर्टिलिटी सॉल्यूशंस की एक पूरी रेंज देते हैं, जो एक भरोसेमंद ऑप्शन है। सीड्स ऑफ़ इनोसेंस IVF मुजफ्फरपुर का सबसे अच्छा IVF सेंटर है। साथ ही, हम अपने सबसे अच्छे फर्टिलिटी स्पेशलिस्ट से एक्सपर्ट केयर देते हैं, जिसमें IVF, ICSI, IUI, एग फ्रीजिंग, ऊसाइट विट्रिफिकेशन, लेजर-असिस्टेड हैचिंग और रिप्रोडक्टिव सर्जरी जैसे कई इलाज शामिल हैं।
        </p>
