              ...
              <div className="space-y-4">
                ...
                <div className="gap-4">
                  ...
                  <p className="text-gray-600">
                    If you are searching for an IVF treatment, then you can meet the best IVF doctor at Seeds of Innocens IVF.
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-gray-700">
                 Our IVF packages are thoughtfully designed to include multiple fertility treatments like IVF, IUI, ICSI, and Egg Freezing while maintaining full transparency.
Our IVF specialists will perform a medical assessment to establish your medical condition and develop a personalized treatment strategy while giving complete details about procedures and their success rates, and expenses to you.
​The Seeds of Innocens IVF team provides transparent guidance to clients while delivering compassionate treatment without any additional expenses.
