    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         We provide our fertility services through a transparent, ethical, and results-oriented care system that utilizes medical standards accepted worldwide. Our fertility care system delivers ethical results through transparent processes that follow medical guidelines established worldwide.
        </p>
