...
export default function PatientSuccessStories() {
  ...
  const videos = [
    ...
    {
      id: 2,
      title: 'शादी के 15 साल बाद हुआ माता-पिता बनने का सपना पूरा। IVF Success Story Seeds of Innocence Meerut',
      videoId: 'QGoN4X9gInE', // Replace with actual YouTube video ID
    },
    {
      id: 3,
      title: 'A young couple from Meerut who was not able to conceive post 10 years of their marriage is now blessed with twins',
