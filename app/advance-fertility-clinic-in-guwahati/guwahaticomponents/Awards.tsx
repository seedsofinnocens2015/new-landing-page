    ...
    <section className="w-full py-38 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
          আমাৰ গ্ৰাহকৰ পিছত আমাৰ বঁটাবোৰে আমাৰ হৈ কথা কয়। আমি আপোনাৰ প্ৰতি নিজকে নিয়োজিত কৰি আহিছো যাতে আপুনি শ্ৰেষ্ঠতকৈ কম একো নাপায়, কাৰণ আপুনি স্ত্ৰীৰোগ, প্ৰসূতি, আৰু শিশু চিকিৎসাৰ উন্নতমানৰ মানদণ্ডৰ যোগ্য। একেদৰে যদি আমি জয়ী হোৱা সকলো স্বাস্থ্যসেৱাৰ ট্ৰফীৰ কাষেৰে যাওঁ, তেন্তে দেখা যায় যে যত্ন লোৱাটোও যথেষ্ট পুৰস্কাৰজনক হ’ব পাৰে।
        </p>
