  ...
  return (
    <section className="relative w-full mt-15">
      ...
      <div className="relative w-full hidden md:block">
        <img 
          src="/gads/assets/image/banner/guwahati A.jpeg"
          alt="Banner"
      ...
      <div className="relative w-full block md:hidden">
        <img 
          src="/gads/assets/image/banner/guwahati A1.jpeg"
          alt="Banner Mobile"
          className="w-full h-auto"
        />
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={isLoading}
                >
                  <option value="" disabled> ভাষা নিৰ্বাচন কৰক</option>
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  আমি সিডস অফ ইনোসেন্স এআইএফ প্রতিনিধিদের থেকে যোগাযোগ করার জন্য সম্মতি প্রদান করছি
                </label>
              </div>
