              ...
              <div className="space-y-4">
                ...
                <div className="gap-4">
                  ...
                  <p className="text-gray-600">
                    Searching for the best IVF doctor in Kolkata? At Seeds of Innocens IVF, you will meet the best IVF specialist who will guide you and take you through each step of the IVF journey with compassion and care.
                  </p>
                </div>
                ...
                <div className=" items-center gap-4">
                  ...
                  <p className="text-gray-600">
                    Get a comprehensive transparency about the IVF treatment and other fertility treatments at a minimal cost with Seeds of Innocens IVF Kolkata, where you can start your parenthood journey.
                  </p>
                </div>
              </div>
            </div>
