...
export default function OurServices() {
  const services = [
    ...
    {
      id: 2,
      title: 'ഭ്രൂണം ഫ്രീസിംഗ്',
      description: 'ഇന്ന് തന്നെ നിങ്ങളുടെ അണ്ഡങ്ങളും ബീജവും ഉപയോഗിച്ച് സൃഷ്ടിച്ച ഭ്രൂണംങ്ങളെ സുരക്ഷിതമായി ഫ്രീസ് ചെയ്തുകൊണ്ട് ഭാവിയിലെ ഗർഭധാരണ ഓപ്ഷനുകൾ സംരക്ഷിക്കുക',
      icon: '/gads/assets/image/icons/embryofreezing.svg',
    },
    {
      id: 3,
      title: 'ഊസൈറ്റ് വിട്രിഫിക്കേഷൻ',
    ...
    },
    {
      ...
      description: 'ഭ്രൂണംത്തിന്റെ പുറംതോട് നേർത്തതാക്കാൻ ഒരു സൗമ്യമായ ലേസർ ഉപയോഗിക്കുന്നു, ഇത് വിരിയാനും ഗർഭാശയവുമായി നന്നായി ബന്ധിപ്പിക്കാനും സഹായിക്കുന്നു.',
    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
          സീഡ്സ് ഓഫ് ഇന്നസെൻസ് IVF കാസറഗോഡ് മികച്ച IVF സ്പെഷ്യലിസ്റ്റുകളിൽ നിന്ന് നൂതന ഫെർട്ടിലിറ്റി സൊല്യൂഷനുകൾ ഉപയോഗിച്ച് പരിചരണം നൽകുന്നു. ഓരോ ദമ്പതികൾക്കും വേണ്ടി രൂപകൽപ്പന ചെയ്ത ഞങ്ങളുടെ IVF പാക്കേജുകൾ ഉപയോഗിച്ച് നിങ്ങൾക്ക് ഇന്ന് തന്നെ IVF കൺസൾട്ടേഷൻ എളുപ്പത്തിൽ ബുക്ക് ചെയ്യാനും ഇന്ത്യയിലെ IVF ചികിത്സയുടെ വില മനസ്സിലാക്കാനും കഴിയും. കൂടാതെ, ഉയർന്ന IVF വിജയ നിരക്കുകളിൽ ഞങ്ങൾ ശ്രദ്ധ കേന്ദ്രീകരിക്കുകയും ഓരോ ഘട്ടത്തിലും IVF പ്രക്രിയയിലൂടെ സമഗ്രമായ മാർഗ്ഗനിർദ്ദേശം നൽകുകയും ചെയ്യുന്നു. വിശ്വസനീയമായ IVF ക്ലിനിക് അവലോകനങ്ങളുടെ പിന്തുണയോടെ വിപുലമായ ICSI ഫെർട്ടിലിറ്റി ചികിത്സ വാഗ്ദാനം ചെയ്യുന്ന മികച്ച IVF കേന്ദ്രങ്ങളിൽ ഒന്നാണ് കാസറഗോഡിലെ ഞങ്ങളുടെ IVF കേന്ദ്രം.
        </p>
