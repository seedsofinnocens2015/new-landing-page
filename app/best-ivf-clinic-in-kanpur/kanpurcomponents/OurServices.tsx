    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         Seeds of Innocens IVF is one of the best fertility clinics in Kanpur, with comprehensive services such as IVF, ICSI, IUI Egg freezing, Embryo Freezing, Ovulation Induction, oocyte vitrification, and reproductive surgery. Our services include the whole fertility solution at an IVF Clinic.
        </p>
