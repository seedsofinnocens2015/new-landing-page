...
export const metadata: Metadata = {
  title: 'Best IVF Clinic in Janakpuri - Seeds Of Innocens Fertility & IVF',
  description: 'Best IVF Clinic in Janakpuri - Seeds Of Innocens Fertility & IVF offers world-class fertility treatments and IVF services. Book your appointment today.',
};
