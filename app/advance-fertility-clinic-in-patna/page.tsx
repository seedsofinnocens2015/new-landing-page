...
export const metadata: Metadata = {
  title: 'Advance Fertility Clinic in Patna - Seeds Of Innocens Fertility & IVF',
  description: 'Advance Fertility Clinic in Patna - Seeds Of Innocens Fertility & IVF offers world-class fertility treatments and IVF services. Book your appointment today.',
};
