    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         सीड्स ऑफ़ इनोसेंस IVF भारत का सबसे अच्छा IVF सेंटर है। यह IVF, IUI, ICSI, एग फ्रीजिंग और दूसरे कई फर्टिलिटी ट्रीटमेंट देने के लिए जाना जाता है। अनगिनत कपल्स के माता-पिता बनने के सपने को पूरा करने से लेकर, हम इस सपने को पूरा करने में विश्वास रखते हैं। इसके अलावा, अगर आप पटना के पास सबसे अच्छे IVF स्पेशलिस्ट की तलाश कर रहे हैं, तो सीड्स ऑफ़ इनोसेंस IVF, पटना जाएँ।
        </p>
