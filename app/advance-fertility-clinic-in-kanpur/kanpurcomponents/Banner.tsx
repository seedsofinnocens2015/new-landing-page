  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        source: 'SOI | IVF | Google Form Fill | Kanpur',
      ...
      router.push('/thankyou?location=kanpur');
    } catch (error: any) {
  ...
  return (
    <section className="relative w-full mt-15">
      ...
      <div className="relative w-full hidden md:block">
        <img 
          src="/gads/assets/image/banner/kanpur H.jpg"
          alt="Banner"
      ...
      <div className="relative w-full block md:hidden">
        <img 
          src="/gads/assets/image/banner/kanpur H1.jpg"
          alt="Banner Mobile"
          className="w-full h-auto"
        />
      </div>
