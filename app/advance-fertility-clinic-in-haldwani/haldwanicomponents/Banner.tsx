  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        source: 'SOI | IVF | Google Form Fill | Haldwani',
      ...
      router.push('/thankyou?location=haldwani');
    } catch (error: any) {
  ...
  return (
    <section className="relative w-full mt-15">
      ...
      <div className="relative w-full hidden md:block">
        <img 
          src="/gads/assets/image/banner/haldwani H.jpg"
          alt="Banner"
      ...
      <div className="relative w-full block md:hidden">
        <img 
          src="/gads/assets/image/banner/haldwani H1.jpg"
          alt="Banner Mobile"
          className="w-full h-auto"
        />
      </div>
