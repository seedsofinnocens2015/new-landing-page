    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         Seeds of Innocens IVF provides a comprehensive range of fertility solutions all across Haldwani, which is a reliable option. Seeds of Innocens IVF is one of the best IVF centres in Haldwani. Moreover, we also offer expert care from our best fertility specialists with several treatments that include IVF, ICSI, IUI, Egg Freezing, and reproductive surgery.
        </p>
