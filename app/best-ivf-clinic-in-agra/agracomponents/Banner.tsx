  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        source: 'SOI | IVF | Google Form Fill | Agra',
      ...
      router.push('/thankyou?location=agra');
    } catch (error: any) {
  ...
  return (
    <section className="relative w-full mt-15">
      ...
      <div className="relative w-full hidden md:block">
        <img 
          src="/gads/assets/image/banner/agra.jpg"
          alt="Banner"
      ...
      <div className="relative w-full block md:hidden">
        <img 
          src="/gads/assets/image/banner/agra1.jpg"
          alt="Banner Mobile"
          className="w-full h-auto"
        />
      </div>
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-12 flex items-end md:items-center justify-end md:justify-end z-10">
