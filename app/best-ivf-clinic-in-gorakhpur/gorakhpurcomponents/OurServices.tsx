    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         Seeds of Innocens IVF is one of the best IVF centre in Gorakhpur. This fertility centre offers comprehensive services like IVF,ICSI,IUI,Embryo Freezing, Egg Freezing and reproductive surgery. Moreover, we believe in providing the best fertility solution at an Seeds of Innocens IVF Gorakhpur.
        </p>
