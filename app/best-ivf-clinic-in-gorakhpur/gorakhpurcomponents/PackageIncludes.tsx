              ...
              <div className="space-y-4">
                ...
                <div className="gap-4">
                  ...
                  <p className="text-gray-600">
                    If you are looking for an IVF treatment near me then you can meet the best IVF specialist at Seeds of Innocens IVF Gorakhpur, where we guide you and turn your parenthood journey with care and compassion.
                  </p>
                </div>
                ...
                <div className=" items-center gap-4">
                  ...
                  <p className="text-gray-600">
                    For a whole transparency on IVF treatment cost in India, high IVF success rates and it will support you through the verified IVF clinic.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-gray-700">
                 Our IVF packages are made to support every couple’s journey with complete transparency regarding IVF treatment costs in India. At Seeds of Innocens IVF, an advanced IVF centre in Gorakhpur, you can meet the best IVF doctor and book an IVF consultation easily. We will guide through each IVF process step by step, it will also include the advanced options such as ICSI fertility treatment and egg freezing.
                </div>
              </div>
            </div>
          </div>
