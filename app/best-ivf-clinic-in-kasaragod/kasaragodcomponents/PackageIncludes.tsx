              ...
              <div className="space-y-4">
                ...
                <div className="gap-4">
                  ...
                  <p className="text-gray-600">
                    You can visit an IVF doctor and specialist at our trusted Seeds of Innocens best  IVF centre in Kasaragod. You can also get expert guidance to start your fertility journey with confidence.
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-gray-700">
                  Looking for an IVF clinic near me in Kasaragod? Now you can book IVF consultation easily and explore the IVF treatment cost in Kasaragod through our best IVF packages with flexible EMI options.
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-gray-600 text-center">
                  You can visit an IVF doctor at Seeds of Innocens best  IVF centre in Kasaragod. You can also get expert guidance to start your fertility journey with confidence.
                </p>
              </div>
