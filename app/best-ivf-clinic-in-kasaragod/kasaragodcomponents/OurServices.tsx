  ...
  return (
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        Seeds of Innocens IVF Kasaragod provides care from the best IVF specialist with advanced fertility solutions. You can easily book IVF consultation today and understand the IVF treatment cost in India with our IVF packages that are designed for each couple. Also, we focus on high IVF success rates and will provide comprehensive guidance through the IVF process with each step. Our IVF centre in Kasaragod is one of the best IVF clinic which provides an advanced ICSI fertility treatment that is supported by the trusted IVF clinic reviews. 
        </p>
