...
export default function Specialists() {
  ...
  const specialists = [
    ...
    },
    {
      ...
      qualifications: 'MBBS, MD, FRM, FMAS',
      specialization: 'IVF, Unexplained Infertility, Recurrent Implantation Failure',
      experience: '22+ Years',
      location: 'Faridabad, Haryana',
      image: '/gads/assets/image/doctor/Dr. Beena Upadhyay.jpg', // Update with actual image path
    },
    {
      id: 6,
    ...
    },
    {
      ...
      image: '/gads/assets/image/doctor/Dr. Aditi Bhatnagar.jpg', // Update with actual image path
    },
    {
      id: 9,
    ...
    },
    {
      ...
      qualifications: 'MBBS & DCH, Fellowship in IVF',
      specialization: 'IVF, Unexplained Infertility, Recurrent Implantation Failure',
      experience: '11+ Years',
      location: 'Meerut, Uttar Pradesh',
      image: '/gads/assets/image/doctor/DR. VARKHA CHANDRA.jpg', // Update with actual image path
    },
    {
      id: 19,
      name: 'Dr. R Sonee Prasad',
      qualifications: 'MBBS, DGO, DNB, Fellowship in IVF',
      specialization: 'IVF, Unexplained Infertility, Recurrent Implantation Failure',
      experience: '10+ Years',
      location: 'Muzaffarpur, Bihar',
      image: '/gads/assets/image/doctor/Dr.rSonee Prasad.png', // Update with actual image path
    },
    {
      id: 20,
      name: 'Dr. Debilina Roy',
      qualifications: 'MBBS, FMAS, DMAS, MS (Obs & Gynae)',
      specialization: 'IVF, Unexplained Infertility, Recurrent Implantation Failure',
      experience: '10+ Years',
      location: 'Patna, Bihar',
      image: '/gads/assets/image/doctor/DR DEBILINA ROY.jpg', // Update with actual image path
    },
    {
      id: 21,
