              ...
              <div className="space-y-4">
                ...
                <div className="gap-4">
                  ...
                  <p className="text-gray-600">
                    At Seeds of Innocens IVF, you can consult our best IVF specialist and get expert guidance to begin your fertility journey with confidence.
                  </p>
                </div>
                ...
                <div className=" items-center gap-4">
                  ...
                  <p className="text-gray-600">
                    Receive a comprehensive fertility evaluation and understand the IVF process with personalized care from our team.
                  </p>
                </div>
              </div>
            </div>
