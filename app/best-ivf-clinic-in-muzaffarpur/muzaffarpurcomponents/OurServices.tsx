    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
         We at Seeds of Innocens IVF include a comprehensive range of fertility solutions across Muzzaffarpur, which is a reliable option. Seeds of Innocens IVF is the best IVF centre in Muzzaffarpur. Also, we offer expert care from our best fertility specialists along with various treatments that include IVF, ICSI, IUI, Egg freezing, Oocyte vitrification, Laser-Assisted Hatching, and reproductive surgery.
        </p>
