...
export default function FAQs() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'അതെ, വിശദമായ ഡയഗ്നോസ്റ്റിക്സ്, ഗർഭാശയ വിലയിരുത്തൽ, ആവശ്യമുള്ളപ്പോൾ ഭ്രൂണ വിശകലനം എന്നിവയിലൂടെ ആവർത്തിച്ചുള്ള IVF പരാജയങ്ങൾ വിലയിരുത്തുന്നതിലും ചികിത്സിക്കുന്നതിലും ഞങ്ങൾ വൈദഗ്ദ്ധ്യം നേടിയിട്ടുണ്ട്',
    },
    {
      id: 4,
