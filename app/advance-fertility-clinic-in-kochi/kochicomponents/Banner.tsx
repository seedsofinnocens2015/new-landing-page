  ...
  return (
    <section className="relative w-full mt-15">
      ...
      <div className="relative w-full hidden md:block">
        <img 
          src="/gads/assets/image/banner/kochi M.jpeg"
          alt="Banner"
      ...
      <div className="relative w-full block md:hidden">
        <img 
          src="/gads/assets/image/banner/kochi M1.jpeg"
          alt="Banner Mobile"
          className="w-full h-auto"
        />
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={isLoading}
                >
                  <option value="" disabled>ഭാഷ തിരഞ്ഞെടുക്കുക</option>
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  സീഡ്സ് ഓഫ് ഇന്നസെൻസ് IVF പ്രതിനിധികളുമായി ബന്ധപ്പെടാൻ ഞാൻ സമ്മതിക്കുന്നു.
                </label>
              </div>
