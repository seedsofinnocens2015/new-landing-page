...
export default function PatientSuccessStories() {
  ...
  const videos = [
    {
      id: 1,
      title: 'ആദ്യ ഐവിഎഫ് ശ്രമത്തിൽ തന്നെ വിജയകരമായി ഗർഭിണിയായി.',
      videoId: '0XD9OrkunWI', // Replace with actual YouTube video ID
    },
    {
      id: 2,
      title: 'നിരവധി ഗർഭഛിദ്രങ്ങൾ പരാജയപ്പെട്ടതിന് ശേഷം ഗർഭിണിയായി.',
      videoId: '5o6SdAfQvWk', // Replace with actual YouTube video ID
    },
    {
      id: 3,
      title: 'ബ്ലാസ്റ്റോ ട്രാൻസ്ഫർ കെ ബാദ് ഭീ ഹുയി ഗർഭിണിയാണ്',
      videoId: '0p-Z6YRXOSU', // Replace with actual YouTube video ID
    },
    {
      id: 4,
      title: '12 വർഷത്തെ കാത്തിരിപ്പ് അവസാനിക്കുന്നത് നിഷ്കളങ്കരുടെ വിത്തുകളുമായി: ഒരു വിജയഗാഥ',
