  ...
  const stats = [
    {
      id: 1,
      number: '20,000+',
      description: 'ആരോഗ്യമുള്ള കുഞ്ഞുങ്ങൾ',
  ...
  return (
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        ഇന്നസെൻസ് ഐവിഎഫ് സീഡ്സ് തിരഞ്ഞെടുക്കുന്നത് എന്തുകൊണ്ട്?
        </h2>
