            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-gray-800 text-base md:text-lg leading-relaxed">
                  2nd floor, Mangaldeep Island(Khaki Estate, 12, Street Number 702, near managaldeep metro station, AA II, Action Area IID, Newtown, New Town, West Bengal 700161
                </p>
              </div>
