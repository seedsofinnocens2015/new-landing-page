...
export default function PatientSuccessStories() {
  ...
  const videos = [
    {
      id: 1,
      title: 'বাস্তব IVF সাফল্যের গল্প, IVF চিকিৎসার ফলাফল',
      videoId: '-Z1SXqVbt40', // Replace with actual YouTube video ID
    },
    {
      id: 2,
      title: '১৩ বছর পর, প্রথম চেষ্টাতেই রোগী গর্ভধারণে সক্ষম হন।',
      videoId: 'MemQgDHNsNQ', // Replace with actual YouTube video ID
    },
    {
      id: 3,
      title: 'প্রথম চেষ্টাতেই রোগী গর্ভধারণে সক্ষম হন।',
      videoId: 'g7LifHVjOYE', // Replace with actual YouTube video ID
    },
    {
      id: 4,
      title: '১ পরীক্ষা পরে প্রজনন| সিডস অফ ইনোসেন্স - IVF',
          ...
          <div className="overflow-hidden relative group">
            <div className="flex gap-10 animate-marquee group-hover:[animation-play-state:paused]">
              {[
                {
                  id: 1,
                  quote: 'এখানে খুব চমৎকার অভিজ্ঞতা হয়েছে... সব কর্মী ও ডাক্তাররা খুবই সহযোগিতাপূর্ণ।',
                  name: 'Anuradha Rai',
                },
                {
                  id: 2,
                  quote: 'চমৎকার সুবিধা, সেরা ডাক্তার... আপনি বিশ্বাস করতে পারেন।',
                  name: 'Nitin Srivastav',
                },
                {
                  id: 3,
                  quote: 'আপনার সেবা সফল হয়েছে। সব কর্মী ও ডাক্তাররা খুবই সহযোগিতাপূর্ণ।',
              ...
              {[
                {
                  id: 5,
                  quote: 'আমার প্রতিরোধ ও ডাক্তার গুরুত্বপূর্ণ। আমি সেদের সাহায্যে তারা প্রজননের পরিকল্পনা পরিচালনা করেছে। আমি সেদের সাহায্যে তারা প্রজননের পরিকল্পনা পরিচালনা করেছে।',
                  name: 'Shweta Sapra',
                },
                {
                  id: 6,
                  quote: 'আমি সেদের সাহায্যে তারা প্রজননের পরিকল্পনা পরিচালনা করেছে। আমি সেদের সাহায্যে তারা প্রজননের পরিকল্পনা পরিচালনা করেছে।',
                  name: 'Hemant Garg',
                },
                {
                  id: 7,
