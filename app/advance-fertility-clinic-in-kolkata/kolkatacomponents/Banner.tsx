  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        source: 'SOI | IVF | Google Form Fill | Kolkata',
      ...
      router.push('/thankyou?location=kolkata');
    } catch (error: any) {
  ...
  return (
    <section className="relative w-full mt-15">
      ...
      <div className="relative w-full hidden md:block">
        <img 
          src="/gads/assets/image/banner/kolkata B.jpeg"
          alt="Banner"
      ...
      <div className="relative w-full block md:hidden">
        <img 
          src="/gads/assets/image/banner/kolkata B1.jpeg"
          alt="Banner Mobile"
          className="w-full h-auto"
        />
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <select
                  ...
                  disabled={isLoading}
                >
                  <option value="" disabled>ভাষা নির্বাচন করুন</option>
              ...
              <div className="flex items-start gap-3">
                ...
                >
                  আমি সিডস অফ ইনোসেন্স IVF -এর প্রতিনিধিদের দ্বারা যোগাযোগ করার জন্য সম্মতি দিচ্ছি।
                </label>
              </div>
