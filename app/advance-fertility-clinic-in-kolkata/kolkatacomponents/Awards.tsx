    ...
    <section className="w-full py-38 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-800 text-center max-w-4xl mx-auto mb-24 leading-relaxed">
          আমাদের গ্রাহকদের পর আমাদের পুরস্কারগুলোই আমাদের কথাই বলে। আমরা আপনাদের জন্য এক দশকেরও বেশি সময় ধরে নিবেদিত থেকে নিশ্চিত করেছি যে আপনি পাবেন কেবল সেরা পরিষেবা, কারণ আপনি যোগ্য সেরা মানের গাইনোকলজি, মাতৃত্বসেবার। একইভাবে, যদি আমরা সব স্বাস্থ্যসেবার পুরস্কারগুলো বিবেচনা করি যা আমরা অর্জন করেছি, তাহলে দেখা যায়—যত্ন নেওয়াও যথেষ্ট ফলপ্রসূ হতে পারে।
        </p>
