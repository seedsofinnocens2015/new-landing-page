...
export default function OurCentres() {
  const [selectedCity, setSelectedCity] = useState('পশ্চিমবঙ্গ');
  ...
  const cities = [
    { id: 1, name: 'দিল্লি', icon: '/gads/assets/image/icons/bangalore-icon.svg' },
    { id: 2, name: 'উত্তরপ্রদেশ', icon: '/gads/assets/image/icons/chandigarh-icon.svg' },
    { id: 3, name: 'বিহার', icon: '/gads/assets/image/icons/chennai-icon.svg' },
    { id: 4, name: 'হরিয়ানা', icon: '/gads/assets/image/icons/coimbatore-icon.svg' },
    { id: 5, name: 'ঝাড়খণ্ড', icon: '/gads/assets/image/icons/gurgaon-icon.svg' },
    { id: 6, name: 'উত্তরাখণ্ড', icon: '/gads/assets/image/icons/indore-icon.svg' },
    { id: 7, name: 'অসম', icon: '/gads/assets/image/icons/mohali-icon.svg' },
    { id: 8, name: 'কেরালা', icon: '/gads/assets/image/icons/mumbai-icon.svg' },
    // { id: 9, name: 'Jammu & Kashmir', icon: '/gads/assets/image/icons/mumbai-icon.svg' },
    { id: 10, name: 'পশ্চিমবঙ্গ', icon: '/gads/assets/image/icons/mumbai-icon.svg' },
  ];

  const centres = [
    {
      id: 1,
      location: 'মালবিয়া নাগর',
    ...
    <section className="w-full py-16 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8">
          ভারতবর্ষ জুড়ে আমাদের কেন্দ্রসমূহ
        </h2>
